...
void binalyWeightedRangeFilter(const Mat& src, Mat& dst, int kernelSize, float threshold, int method, int borderType)
{
	binalyWeightedRangeFilter(src,dst,Size(kernelSize,kernelSize),threshold,method,borderType);
}
